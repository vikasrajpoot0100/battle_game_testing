...
from src.AgentTypes.TeamAgents import RLAgent_One, RLAgent_Two
            ...
            for sock in readable:
                if sock is conn:
                    ...
                    if data:
                        ...
                        print('First While')
                        print('State0',State0)
                        print('State0.Units',State0.Units)
                        print('State0.FlagPosition',State0.FlagPosition)
                        
                        print('AgentDict',AgentDict)
            else:
...
GameDic[0] = RLAgent_One(0, 0)
GameDic[1] = RLAgent_Two(1, 0) 
...
if GameType == '--train':
    ...
    for PlayerID in Connections.keys():
        print("///////////////////////////////////////////////////////////////////////")
        print('RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR',R)
        data = {1: R[1],
                'contents': 'Game Over'}
