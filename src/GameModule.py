...
class GameClass(object):
    ...
    def play(self, State: StateClass):
        ...
        file_path = "./data/ReturnTable_1.json"
        with open(file_path, 'r') as json_file:
            Qlearning_table_1 = json.load(json_file)
        
        
        file_path = "./data/ReturnTable_2.json"
        with open(file_path, 'r') as json_file:
            Qlearning_table_2 = json.load(json_file)
        ...
        while GameOn:
            ...
            for (AgentID, ObservedState) in ObservedStates.items():
                ...
                if AgentID in [0]:
                    AgentAction = Agent.chooseActions(ObservedState, State, Qlearning_table_1) 
