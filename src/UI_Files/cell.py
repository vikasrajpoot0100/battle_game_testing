...
class Cell(object, metaclass=CellProperties):
    ...
    def configure(self, **kwargs):
        """
        Configures the cell properties.
        """
        if "highlight" in kwargs:
            highlight = kwargs.pop("highlight")
            if highlight:
                kwargs["width"] = 5  # Set border width to 5
                kwargs["outline"] = "green"  # Set border color to red
            else:
                kwargs["width"] = 0  # Remove border
        self._canvas.itemconfig(self._id, **kwargs) 
    ...
    def configure_cell(self, **kwargs):
        ...
        if "highlight" in kwargs:
            highlight = kwargs.pop("highlight")
            if highlight:
                kwargs["width"] = 2  # Set border width to 2
                kwargs["outline"] = "light grey"  # Set border color to red
            else:
                kwargs["width"] = 0  # Remove border
        self._canvas.itemconfig(self._id, **kwargs) 
        
        
    def configure_cell_yellow(self, **kwargs):
        """
        Configures the cell properties.
        """
        if "highlight" in kwargs:
            ...
            if highlight:
                kwargs["width"] = 2  # Set border width to 2
                kwargs["outline"] = "yellow"  # Set border color to red
            else:
                kwargs["width"] = 0  # Remove border
        self._canvas.itemconfig(self._id, **kwargs)
